...
const UserSettingTable = ({ target, setShowSetting, name }) => {
...
const handleResetClick = (senderName, status) => {
  ...
  return (
    ...
    >
      <div className="manage-modal-content" style={{width: "60%", maxHeight: "500px", overflowX: "auto", overflowY: "auto"}}>
                  ...
                  <td>
                    <p className="notification_actions">
                      <FaEnvelope
                        ...
                        onClick={() => handleResetClick(item.senderName, item.status)}
                      />
        ...
        {showOpen && (
        <PasswordReset name={name} setShowOpen={setShowOpen} toggleShow={toggleShow} />
      )}
        <Pagination
